...
/**
 * Created by cpfei on 2019/3/18.
 */

public class ScanGunHelper {
    private int INPUT_RQCODE  =1;// 扫码枪回调类型为1
    private int INPUT_ID_IC_CARD  =2;// usb 读卡器回调类型为2
    ...
    private void performScanSuccess() {
        try {
            ...
            if (mOnScanSuccessListener != null && !TextUtils.isEmpty(barcode)) {
                mOnScanSuccessListener.onScanSuccess(1,barcode);
            }
