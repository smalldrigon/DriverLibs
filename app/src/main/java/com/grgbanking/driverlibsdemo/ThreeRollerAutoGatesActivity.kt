...
import kotlinx.android.synthetic.main.layout_threerollergates_activity.tvn_open2
import kotlinx.android.synthetic.main.layout_threerollergates_activity.tvn_open2_aways
import kotlinx.android.synthetic.main.layout_threerollergates_activity.tvn_open2_right
import kotlinx.android.synthetic.main.layout_threerollergates_activity.tvn_open2_right_aways
...
class ThreeRollerAutoGatesActivity : AppCompatActivity(),IGateMachineActionCallBack {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.layout_threerollerautogates_activity)
        initView()
    }
    var mHhandle: Int = 0
...
fun setText1(str:String){
    ...
    private fun initView() {
        DriverManagers.Builder().setContext(this)
            ...
            .setGateMachine(DriverManagers.GATEMACHINE_TYPE_TJZN01)
...
//            DriverManagers.instance.driver_GateMachine.init(mHhandle, devreturn)
            ...
            mHhandle = DriverManagers.instance.driver_GateMachine.openLogicDevice(DriverManagers.GATEMACHINE_TYPE_TJZN01,Contants.CONFIG_FILE_PATH,Contants.CONFIG_FILE_PATH)
