...
public class MQTTService extends Service {
    ...
    public static void publish(String msg){
     ...
     private void init() {
        // 服务器地址（协议+地址+端口号）
        String uri = host;
        client = new MqttAndroidClient(this, uri, SystemUtils.INSTANCE.getMacAddress(this));
        // 设置MQTT监听并且接受消息
        ...
        String message = "{\"terminal_uid\":\"" + SystemUtils.INSTANCE.getMacAddress(this) + "\"}";
