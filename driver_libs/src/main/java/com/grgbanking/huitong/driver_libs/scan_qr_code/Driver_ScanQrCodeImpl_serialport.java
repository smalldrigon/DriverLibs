...
public class Driver_ScanQrCodeImpl_serialport implements IDriver_ScanGun {
    ...
    private List<SerialPortManager> serialPortManagerList = null;
     ...
     */
    public boolean startScan(Map<String, String> portRateMap, OnSerialPortDataListener... dateListener) {
        ...
        serialPortManagerList = new ArrayList<>();
        Iterator it = portRateMap.keySet().iterator();
        while (it.hasNext()) {
            Map.Entry<String, String> entry = (Map.Entry<String, String>) it.next();
            SerialPortManager serialPortManager = new SerialPortManager();
            serialPortManager.setOnSerialPortDataListener(dateListener[0])
            ...
            serialPortManagerList.add(serialPortManager);
        }
