...
public class Driver_GateTJZN01Impl extends IDriver_GateMachine {
    ...
    public int openLogicDevice(String p_pcLogicDevName, String configFilePath, String logFilePath) {
        ...
        mGetPassByNumThread = new GetPassByNumThread(getIGateMachineActionCallBack(), IGateDev_TJZN01.mInstance, mHandle);
...
//        getIGateMachineActionCallBack().openRight(ret == 0);
    ...
    class GetPassByNumThread extends Thread {
        ...
        private IGateDev_TJZN01 mGatemachine;
        private int mHandle = -1;
        ...
        public GetPassByNumThread(IGateMachineActionCallBack callBack, IGateDev_TJZN01 gatemachine, int handle) {
        ...
        public void run() {
            ...
            if (mGatemachine == null || mCallBack == null) {
                throw new NullPointerException("请先初始化 IGateDev_TJZN01  或者设置回调 IGateMachineActionCallBack");
            }
            while (true) {
